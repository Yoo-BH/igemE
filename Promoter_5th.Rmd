...
igem_team <- bind_rows(igem_team1, igem_team2, igem_team3, igem_team4)
igem_team
```
## part
```{r}
...
igem_part <- bind_rows(igem_part1, igem_part2, igem_part3, igem_part4)
igem_part
```
...
igem_obs <- bind_rows(igem_obs1, igem_obs2, igem_obs3, igem_obs4)
igem_obs
```
